...
<head>
    ...
    <link href="/assets/landingpage/css/fontawesome-all.min.css" rel="stylesheet">
    <link href="/assets/landingpage/css/swiper.css" rel="stylesheet">
    <link href="/assets/landingpage/css/styles.css" rel="stylesheet">

    <!-- Favicon  -->
    <link rel="icon" href="/assets/landingpage/images/favicon.png">
</head>
...
<body data-bs-spy="scroll" data-bs-target="#navbarExample">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="grid">
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="/assets/landingpage/images/project-1.jpg" alt="alternative">
                                <p><strong>Online banking</strong> - pellentesque tincidunt leo eu laoreedt integer quis vanos compren</p>
                            </a>
                        </div>
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="/assets/landingpage/images/project-2.jpg" alt="alternative">
                                <p><strong>Loans company</strong> - odio semper, interdum orci molestie, mattis lectus pellentesq aliqu</p>
                            </a>
                        </div>
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="/assets/landingpage/images/project-3.jpg" alt="alternative">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <img class="decoration-lines" src="/assets/landingpage/images/decoration-lines.svg" alt="alternative"><span>Landing page</span><img class="decoration-lines flipped" src="/assets/landingpage/images/decoration-lines.svg" alt="alternative">
                            </div>
                            <ul class="list-unstyled li-space-lg">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <img class="decoration-lines" src="/assets/landingpage/images/decoration-lines.svg" alt="alternative"><span>Corporate site</span><img class="decoration-lines flipped" src="/assets/landingpage/images/decoration-lines.svg" alt="alternative">
                            </div>
                            <ul class="list-unstyled li-space-lg">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <img class="decoration-lines" src="/assets/landingpage/images/decoration-lines.svg" alt="alternative"><span>Online shop</span><img class="decoration-lines flipped" src="/assets/landingpage/images/decoration-lines.svg" alt="alternative">
                            </div>
                            <ul class="list-unstyled li-space-lg">
    ...
    <div class="footer bg-gray">
        <img class="decoration-city" src="/assets/landingpage/images/decoration-city.svg" alt="alternative">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <button onclick="topFunction()" id="myBtn">
        <img src="/assets/landingpage/images/up-arrow.png" alt="alternative">
    </button>
    <!-- end of back to top button -->

    <!-- Scripts -->
    <script src="/assets/landingpage/js/bootstrap.min.js"></script> <!-- Bootstrap framework -->
    <script src="/assets/landingpage/js/swiper.min.js"></script> <!-- Swiper for image and text sliders -->
    <script src="/assets/landingpage/js/purecounter.min.js"></script> <!-- Purecounter counter for statistics numbers -->
    <script src="/assets/landingpage/js/isotope.pkgd.min.js"></script> <!-- Isotope for filter -->
    <script src="/assets/landingpage/js/scripts.js"></script> <!-- Custom scripts -->
</body>
