...
;( function( window ) {
	...
	stepsForm.prototype._showError = function( err ) {
		...
		switch( err ) {
			case 'EMPTYSTR' : 
				message = 'Mohon Isi Jawaban Terlebih Dahulu Sebelum Melanjutkan';
				break;
			case 'INVALIDEMAIL' : 
				message = 'Mohon Isi Dengan Email Yang Valid';
				break;
			case 'NUMBER' : 
				message = 'Mohon Isi Dengan 12 Digit Angka';
				break;
			case 'MNUMBER' : 
				message = 'Harap Isi Dengan Angka';
				break;
			case 'TEXT' : 
				message = 'Harap Isi Dengan Jawaban "Hadir" atau "Tidak"';
				break;
			// ...
		};
