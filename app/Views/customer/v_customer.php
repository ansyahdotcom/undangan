                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="input-group bulk-input-group col-md-4">
                                    <select class="form-control" name="bulk">
                                        ...
                                        <option value="/customer/bulk_delete">Hapus data</option>
                                    </select>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($customer as $cust) : ?>
                                        <tr>
                                            <td class="td-check"><input type="checkbox" class="check-it" name="check[]" value="<?= $cust['id_tr']; ?>" title="pilih data ini (<?= $cust['id_tr']; ?>)"></td>
                                            ...
                                            <td><?= $cust['nama_pria'] . '  &  ' . $cust['nama_wanita']; ?></td>
...
<?php foreach ($customer as $cust) : ?>
    <!-- delete modal -->
    <div class="modal fade" id="del-modal<?= $cust['id_tr']; ?>">
            ...
            <div class="modal-content">
                ...
                <form action="/customer/delete" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="id" value="<?= $cust['id_tr'] ?>">
                    </div>
