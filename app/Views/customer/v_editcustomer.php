        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <!-- form start -->
                    <form action="/customer/update" class="quickForm" method="POST" enctype="multipart/form-data">
                        <!-- CSRF Protection -->
                        <?= csrf_field(); ?>
                        ...
                        <div class="bs-stepper-content">
                            ...
                            <div id="data-part" class="content" role="tabpanel" aria-labelledby="data-part-trigger">
                                ...
                                <!-- data diri pengantin -->
                                <input type="hidden" name="id" value="<?= $cst['id_tr']; ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nm_pria" class="form-control" id="nm_pria" value="<?= $cst['nama_pria']; ?>" placeholder="masukkan nama pria" autofocus>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="">Nama Wanita <span class="text-danger">*</span></label>
                                                <input type="text" name="nm_wanita" class="form-control" id="nm_wanita" value="<?= $cst['nama_wanita']; ?>" placeholder="masukkan nama wanita">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="">Nomor HP <span class="text-danger">*</span></label>
                                                <input type="text" name="no_hp" class="form-control" id="no_hp" value="<?= $cst['nomor_hp']; ?>" placeholder="masukkan nomor hp">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-footer">
                                    <div class="d-flex justify-content-between">
                                        <a href="/customer" class="btn btn-secondary"><i class="fas fa-times"></i> Batal</a>
